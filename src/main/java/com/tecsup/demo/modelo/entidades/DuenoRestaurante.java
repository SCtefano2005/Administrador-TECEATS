...
@Entity
@Table(name = "dueñorestaurante")
public class DuenoRestaurante {
    ...
    // Constructores
    public DuenoRestaurante() {}

    public DuenoRestaurante(String nombre, String correoElectronico, String telefono, String googleId) {
        this.nombre = nombre;
